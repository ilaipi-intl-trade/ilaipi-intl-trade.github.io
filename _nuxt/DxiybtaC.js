import{_ as R}from"./B54Z19yI.js";import{_ as z}from"./tiF_snPY.js";import{_ as W}from"./6ETAZGtE.js";import{u as Q}from"./B7xX6Qq_.js";import{a as U,b as M,u as F,n as V}from"#entry";import{_ as D}from"./DlAUqK2U.js";import{O as h,Q as p,L as N,a9 as B,U as t,a3 as x,X as d,u as i,a1 as _,a2 as k,c as T,W as P,a4 as A,a0 as O,a5 as E,b as q,w as Y,o as G}from"./Co5tMnYY.js";import{_ as $}from"./Bbo0jKgt.js";import{M as L}from"./C5MGQOzy.js";import"./Bvi1VPMX.js";import"./zWPNylOE.js";import"./C7xmkHdv.js";const X={class:"cart-items-section"},J={class:"cart-item-content"},K={class:"cart-item-image"},Z={class:"cart-item-info"},tt={class:"cart-item-header"},et={class:"cart-item-title"},ot=["onClick"],st={class:"cart-item-price"},at={class:"price-total"},nt={class:"price-detail"},rt={class:"cart-item-controls"},it={class:"quantity-controls"},lt=["onClick"],ct=["value","onInput"],dt=["onClick"],ut={__name:"CartItemList",props:{items:{type:Array,required:!0}},emits:["removeItem","increaseQuantity","decreaseQuantity","updateQuantity"],setup(u,{emit:r}){const l=r,m=U(),{trackRemoveFromCart:b}=Q(),v=y=>{const n=m.items.find(o=>o.bagId===y);n&&b(n.bag.id,`${n.bag.id} Handbag`,n.bag.price,n.quantity,"Handbag"),l("removeItem",y)},w=y=>{l("increaseQuantity",y)},C=y=>{l("decreaseQuantity",y)},S=(y,n)=>{const o=Number.parseInt(n)||20;l("updateQuantity",y,o)};return(y,n)=>{const o=W;return p(),h("div",X,[(p(!0),h(N,null,B(u.items,s=>(p(),h("div",{key:s.bagId,class:"cart-item-card"},[t("div",J,[t("div",K,[x(o,{src:s.bag.images[0].url,alt:s.bag.images[0].alt,class:"h-full w-full object-cover",loading:"lazy",width:96,height:96,format:"webp"},null,8,["src","alt"])]),t("div",Z,[t("div",tt,[t("div",null,[t("h3",et,d(s.bag.id)+" Handbag",1)]),t("button",{onClick:e=>v(s.bagId),class:"cart-item-remove"},[...n[0]||(n[0]=[t("svg",{class:"h-5 w-5",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor"},[t("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M6 18L18 6M6 6l12 12"})],-1)])],8,ot)]),t("div",st,[t("p",at," ¥"+d((s.bag.price*s.quantity).toLocaleString()),1),t("p",nt," ¥"+d(s.bag.price)+" × "+d(s.quantity),1)]),t("div",rt,[t("div",it,[t("button",{onClick:e=>C(s.bagId),class:"quantity-btn"}," - ",8,lt),t("input",{value:s.quantity,onInput:e=>S(s.bagId,e.target.value),type:"number",min:"50",step:"50",class:"quantity-input"},null,40,ct),t("button",{onClick:e=>w(s.bagId),class:"quantity-btn"}," + ",8,dt)])])])])]))),128))])}}},pt=D(ut,[["__scopeId","data-v-1f8234c5"]]),mt={class:"cart-summary-section"},gt={class:"cart-summary-card"},yt={class:"cart-summary-details"},ht={class:"summary-row"},ft={class:"summary-row"},bt={class:"summary-row"},xt={key:0,class:"text-success"},vt={key:1},wt={class:"summary-total"},_t={class:"total-amount"},kt={class:"total-usd"},$t={key:0},Ct={key:1},St={class:"cart-summary-actions"},It={__name:"CartSummary",props:{totalItems:{type:Number,required:!0},totalPrice:{type:Number,required:!0},shippingCost:{type:Number,required:!0},totalWithShipping:{type:Number,required:!0}},emits:["sendToWholesaler","continueShopping"],setup(u,{emit:r}){const l=r,m=U(),b=M(),{trackBeginCheckout:v,trackUserInteraction:w,trackButtonClick:C}=Q(),S=()=>{if(!m.items||m.items.length===0)return;const s=m.items.reduce((g,c)=>g+c.quantity,0),e=b.convertCNYToUSD(m.totalPrice);let f=`ID	Qty	RMB	USD	Total RMB	Total USD
`;m.items.forEach(g=>{const c=b.convertCNYToUSD(g.bag.price),a=g.bag.price*g.quantity,I=b.convertCNYToUSD(a);f+=`${g.bag.id}	${g.quantity}	${g.bag.price}	${c?c.toFixed(2):"N/A"}	${a}	${I?I.toFixed(2):"N/A"}
`}),f+=`
`,f+=`Total Items:	${s}
`,f+=`RMB:	${m.totalPrice}
`,f+=`USD:	${e?e.toFixed(2):"N/A"}
`,navigator.clipboard&&window.isSecureContext?navigator.clipboard.writeText(f).then(()=>{const g=encodeURIComponent(f),c=`https://wa.me/${L}?text=${g}`;try{window.location.href=c}catch{window.open(c,"_blank","noopener,noreferrer")}}).catch(g=>{console.error("Modern clipboard API failed:",g),y(f)}):y(f)},y=s=>{try{const e=document.createElement("textarea");e.value=s,e.style.position="fixed",e.style.left="-999999px",e.style.top="-999999px",document.body.append(e),e.focus(),e.select();const f=document.execCommand("copy");if(e.remove(),f){const g=encodeURIComponent(s),c=`https://wa.me/${L}?text=${g}`;try{window.location.href=c}catch{window.open(c,"_blank","noopener,noreferrer")}}else{const g=`https://wa.me/${L}`;try{window.location.href=g}catch{window.open(g,"_blank","noopener,noreferrer")}}}catch(e){console.error("Fallback copy failed:",e);const f=`https://wa.me/${L}`;try{window.location.href=f}catch{window.open(f,"_blank","noopener,noreferrer")}}},n=()=>{if(m.items.length>0){const s=m.items.map(e=>({item_id:e.bag.id,item_name:`${e.bag.id} Handbag`,item_category:"Handbag",price:e.bag.price,quantity:e.quantity}));v(s,m.totalPrice),w("send_to_wholesaler","cart_page",{item_count:m.items.length}),C("send_to_wholesaler","cart_page",{item_count:m.items.length,total_value:m.totalPrice}),S()}l("sendToWholesaler")},o=()=>{l("continueShopping")};return(s,e)=>(p(),h("div",mt,[t("div",gt,[e[8]||(e[8]=t("h2",{class:"cart-summary-title"},"Wish List Summary",-1)),e[9]||(e[9]=t("div",{class:"cart-summary-title-divider"},null,-1)),t("div",yt,[t("div",ht,[e[0]||(e[0]=t("span",null,"Items",-1)),t("span",null,d(u.totalItems)+" pieces",1)]),t("div",ft,[e[1]||(e[1]=t("span",null,"Subtotal",-1)),t("span",null,"¥"+d(u.totalPrice.toLocaleString()),1)]),t("div",bt,[e[2]||(e[2]=t("span",null,"Shipping",-1)),u.shippingCost===0?(p(),h("span",xt," Free ")):(p(),h("span",vt,"¥"+d(u.shippingCost.toLocaleString()),1))]),e[4]||(e[4]=t("div",{class:"shipping-info"},[t("p",null,"• 500 pieces or more for free shipping"),t("p",null," • Factory to transit warehouse shipping (not international logistics) ")],-1)),e[5]||(e[5]=t("div",{class:"cart-summary-divider"},null,-1)),t("div",wt,[e[3]||(e[3]=t("span",null,"Total",-1)),t("div",_t,[t("div",null,"¥"+d(u.totalWithShipping.toLocaleString()),1),t("div",kt,[i(b).isLoading?(p(),h("span",$t," Loading USD... ")):(p(),h("span",Ct,d(i(b).formatUSDPrice(u.totalWithShipping)||"USD price unavailable"),1))])])])]),e[10]||(e[10]=t("div",{class:"cart-summary-section-divider"},null,-1)),t("div",St,[e[7]||(e[7]=t("div",{class:"whatsapp-notice"},[t("p",null," 💬 Click to jump to WhatsApp customer service chat, pls feel free to click send ")],-1)),x(i($),{size:"lg",variant:"enhanced",class:"send-button",style:{color:"white","background-color":"#4a3429"},onClick:n},{default:_(()=>[...e[6]||(e[6]=[k(" Send To Wholesaler ",-1)])]),_:1}),t("div",{class:"continue-shopping"},[t("button",{onClick:o,class:"continue-shopping-btn"}," Browse More Products >> ")])]),e[11]||(e[11]=t("div",{class:"cart-summary-section-divider"},null,-1)),e[12]||(e[12]=t("div",{class:"welcome-message"},[t("p",null," 🌟 Our handbag styles are very popular worldwide! Welcome to place your order and experience our premium quality products. ")],-1))])]))}},Dt=D(It,[["__scopeId","data-v-b64d9614"]]),Lt={class:"mb-6 flex items-center justify-between"},Tt={class:"flex items-center gap-4"},Pt={class:"text-sm text-gray-600 dark:text-gray-300"},qt={class:"font-semibold text-gray-900 dark:text-white"},Qt={class:"mb-6 overflow-x-auto"},Ut={class:"w-full border-collapse"},Wt={class:"px-4 py-3"},Mt={class:"flex flex-col items-center gap-2"},Nt={class:"h-16 w-16 overflow-hidden rounded-lg bg-gray-100 dark:bg-gray-800"},Bt={class:"text-xs font-medium text-gray-600 dark:text-gray-300"},At={class:"px-4 py-3 text-center text-sm text-gray-900 dark:text-white"},Ot={class:"px-4 py-3 text-right text-sm text-gray-900 dark:text-white"},Ht={class:"px-4 py-3 text-right text-sm font-semibold text-gray-900 dark:text-white"},jt={class:"border-t-2 border-gray-200 bg-gray-50 dark:border-gray-700 dark:bg-gray-800"},Rt={class:"px-4 py-3 text-center text-sm font-semibold text-gray-900 dark:text-white"},zt={class:"px-4 py-3 text-center text-sm font-semibold text-gray-900 dark:text-white"},Ft={class:"px-4 py-3 text-right text-sm font-semibold text-gray-900 dark:text-white"},Vt={class:"px-4 py-3 text-right"},Et={class:"text-primary text-lg font-bold"},Yt={class:"text-sm font-normal text-gray-600 dark:text-gray-300"},Gt={key:0},Xt={key:1},Jt={class:"flex gap-3"},Kt={__name:"CheckoutDialog",props:{isOpen:{type:Boolean,default:!1},cartItems:{type:Array,default:()=>[]},totalPrice:{type:Number,default:0},shippingCost:{type:Number,default:0}},emits:["close"],setup(u,{emit:r}){const l=u,m=r,b=M(),v=T(()=>l.cartItems.reduce((n,o)=>n+o.quantity,0)),w=T(()=>l.totalPrice-l.shippingCost),C=async()=>{try{let n="";n+=`Order Date: ${new Date().toLocaleDateString()}
